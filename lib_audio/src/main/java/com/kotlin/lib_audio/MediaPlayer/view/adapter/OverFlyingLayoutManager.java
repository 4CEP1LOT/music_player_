...
public class OverFlyingLayoutManager extends RecyclerView.LayoutManager
    ...
    /**
     * cause elevation is not support below com.kotlin.lib_base.api 21,
     * so you can set your elevation here for supporting it below com.kotlin.lib_base.api 21
     ...
     * When set to true, If Recycler is LTR, than it will
     * layout from RTL, if Recycler is RTL, it will layout
     * from LTR.
     */
